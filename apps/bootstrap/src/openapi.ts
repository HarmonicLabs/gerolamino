...
export const openapiSpec = {
  ...
  info: {
    ...
    version: "0.1.0",
    description: "Streams Mithril snapshot data and proxies Ouroboros miniprotocols for Cardano browser nodes.",
  },
  paths: {
    "/info": {
      get: {
...
export const asyncapiSpec = {
  ...
  components: {
    messages: {
      ...
      LedgerState: { name: "LedgerState", title: `Tag 0x${MessageTag.LedgerState.toString(16).padStart(2, "0")}` },
      LedgerMeta: { name: "LedgerMeta", title: `Tag 0x${MessageTag.LedgerMeta.toString(16).padStart(2, "0")}` },
      LmdbEntries: { name: "LmdbEntries", title: `Tag 0x${MessageTag.LmdbEntries.toString(16).padStart(2, "0")}` },
      Progress: { name: "Progress", title: `Tag 0x${MessageTag.Progress.toString(16).padStart(2, "0")}` },
      Complete: { name: "Complete", title: `Tag 0x${MessageTag.Complete.toString(16).padStart(2, "0")}` },
    },
  },
}
