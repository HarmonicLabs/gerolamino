 ...
 * growing, no copying.
 */
export declare const packToUint8Array: <T>(codec: MemPackCodec<T>, value: T) => Uint8Array;
/**
 ...
 */
export declare const unpackFromUint8Array: <T>(codec: MemPackCodec<T>, bytes: Uint8Array) => T;
//# sourceMappingURL=MemPackCodec.d.ts.map