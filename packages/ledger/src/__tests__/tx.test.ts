...
import {
  TxIn, TxOut, TxBody, Tx, TxWitnessSet,
  TxInBytes, TxOutBytes, TxBodyBytes,
  decodeTxIn, encodeTxIn, decodeTxOut, encodeTxOut,
  decodeTxBody, encodeTxBody,
    ...
    Effect.gen(function* () {
      ...
      const cbor: CborSchemaType = {
        ...
        entries: [
          ...
          { k: { _tag: CborKinds.UInt, num: 2n }, v: {
            _tag: CborKinds.Array,
            items: [{ _tag: CborKinds.UInt, num: 0n }, { _tag: CborKinds.Bytes, bytes: datumHash }],
          }},
        ],
      }
      const decoded = yield* decodeTxOut(cbor)
        ...
        entries: [
          {
            ...
            v: { _tag: CborKinds.Array, items: [{
              _tag: CborKinds.Array,
              items: [{ _tag: CborKinds.Bytes, bytes: txId32 }, { _tag: CborKinds.UInt, num: 0n }],
            }]},
          },
          {
            ...
            v: { _tag: CborKinds.Array, items: [{
              ...
              entries: [
                { k: { _tag: CborKinds.UInt, num: 0n }, v: { _tag: CborKinds.Bytes, bytes: addr29 } },
                { k: { _tag: CborKinds.UInt, num: 1n }, v: { _tag: CborKinds.UInt, num: 1500000n } },
              ],
            }]},
          },
        ...
        entries: [
          {
            ...
            v: { _tag: CborKinds.Array, items: [{
              _tag: CborKinds.Array,
              items: [{ _tag: CborKinds.Bytes, bytes: txId32 }, { _tag: CborKinds.UInt, num: 1n }],
            }]},
          },
          {
            k: { _tag: CborKinds.UInt, num: 1n },
            v: { _tag: CborKinds.Array, items: [{
              ...
              entries: [
                { k: { _tag: CborKinds.UInt, num: 0n }, v: { _tag: CborKinds.Bytes, bytes: addr29 } },
                { k: { _tag: CborKinds.UInt, num: 1n }, v: { _tag: CborKinds.UInt, num: 3000000n } },
              ],
            }]},
          },
