...
// ---------------------------------------------------------------------------
// Cost models — Map<Language, Array<Int>>
// CBOR: Map{0?: [166 ints], 1?: [175 ints], 2?: [251 ints]}
// Where key 0=PlutusV1, 1=PlutusV2, 2=PlutusV3
// ---------------------------------------------------------------------------

export const CostModels = Schema.Struct({
  plutusV1: Schema.optional(Schema.Array(Schema.BigInt)), // 166 params
...
export const PParams = PV.Struct({
  ...
  costModels: PV.FieldExcept(["shelley"])(CostModels),
