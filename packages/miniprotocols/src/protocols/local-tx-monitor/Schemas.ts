...
export type MempoolSizes = typeof MempoolSizesSchema.Type;
...
export type LocalTxMonitorMessageT = typeof LocalTxMonitorMessage.Type;
...
export const LocalTxMonitorMessageBytes = cborSyncCodec(
