  ...
  Schema.decodeTo(LocalTxMonitorMessage, {
      ...
      switch (Number(tag.num)) {
        ...
        case 1:
          return {
            ...
            slot: Number((cbor.items[1] as Extract<CborSchemaType, { _tag: CborKinds.UInt }>).num),
          };
        case 2:
        ...
        case 5:
          return {
            ...
            txId: (cbor.items[1] as Extract<CborSchemaType, { _tag: CborKinds.Bytes }>).bytes,
          };
        case 6:
          return {
            _tag: LocalTxMonitorMessageType.ReplyHasTx as const,
            hasTx: (cbor.items[1] as Extract<CborSchemaType, { _tag: CborKinds.Simple }>)
              .value as boolean,
          };
        case 7:
        ...
        case 8:
          return {
            ...
            sizes: {
              ...
              size: Number(
                (cbor.items[2] as Extract<CborSchemaType, { _tag: CborKinds.UInt }>).num,
              ),
              txCount: Number(
                (cbor.items[3] as Extract<CborSchemaType, { _tag: CborKinds.UInt }>).num,
              ),
            },
          };
        default:
    ...
    encode: SchemaGetter.transform(
      LocalTxMonitorMessage.match({
        Acquire: (): CborSchemaType => ({
          _tag: CborKinds.Array,
          items: [{ _tag: CborKinds.UInt, num: 0n }],
        }),
        Acquired: (m): CborSchemaType => ({
          _tag: CborKinds.Array,
          items: [
            { _tag: CborKinds.UInt, num: 1n },
            { _tag: CborKinds.UInt, num: BigInt(m.slot) },
          ],
        }),
        ...
        HasTx: (m): CborSchemaType => ({
          _tag: CborKinds.Array,
          items: [
            { _tag: CborKinds.UInt, num: 5n },
            { _tag: CborKinds.Bytes, bytes: m.txId },
          ],
        }),
        ReplyHasTx: (m): CborSchemaType => ({
          _tag: CborKinds.Array,
          items: [
            { _tag: CborKinds.UInt, num: 6n },
            { _tag: CborKinds.Simple, value: m.hasTx },
          ],
        }),
        GetSizes: (): CborSchemaType => ({
          _tag: CborKinds.Array,
        ...
        Done: (): CborSchemaType => ({
          _tag: CborKinds.Array,
          items: [{ _tag: CborKinds.UInt, num: 9n }],
        }),
      }),
    ),
  }),
